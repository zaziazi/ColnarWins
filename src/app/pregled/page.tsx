...
import { getCurrentStaff, getCustomers, getMonthlyOrderTotals, getReceivablesAgeing } from "@/lib/data";
...
export default async function DashboardPage() {
  ...
  if (!staff || staff.role !== "manager") {
    return (
      <AppShell title="Pregled" who="Marija · pisarna">
  ...
  const [monthly, ageing, customers] = await Promise.all([
